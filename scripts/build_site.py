...
from switch2db.site import TitleView, build_footer_text, build_title_views, select_published_titles
...
def main() -> int:
    """Genera la web estática en docs/ con los títulos revisados de titles.yaml y sus SKUs."""
    ...
    published_titles = select_published_titles(titles)
    title_views = build_title_views(published_titles, skus)
